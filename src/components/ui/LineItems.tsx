  ...
  return (
    <div>
      <div className="mb-2 flex items-center justify-between">
        ...
        <button
          type="button"
          className="crm-btn crm-btn-secondary !py-1 !text-xs"
      ...
      <div className="mt-3 ml-auto w-64 space-y-1 text-sm">
        <div className="flex justify-between"><span className="text-gray-500">Sub Total</span><span>{formatMoney(sub)}</span></div>
        <div className="flex justify-between"><span className="text-gray-500">Discount</span><span>{formatMoney(disc)}</span></div>
        <div className="flex justify-between"><span className="text-gray-500">Tax</span><span>{formatMoney(tax)}</span></div>
        <div className="flex justify-between border-t pt-1 font-semibold"><span>Grand Total</span><span className="text-[var(--crm-blue)]">{formatMoney(grand)}</span></div>
      </div>
    </div>
  );
}
